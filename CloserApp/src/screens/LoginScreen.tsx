...
const LoginScreen = ({navigation}) => {
    ...
    const handleLogin = async () => {
        ...
        try {
            ...
            // No need for manual navigation, AuthNavigator will update automatically
        } catch (err) {
            // @ts-ignore
        ...
        >
            <LinearGradient colors={['rgba(0,0,0,0.6)', 'transparent']} style={styles.overlay}>
                <View style={styles.container}>
                    <Text variant="headlineMedium" style={styles.title}>"Come to me, all who are weary, and I will give
                        you rest"</Text>
